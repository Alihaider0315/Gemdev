...
import RulesBaner from "../src/talenthunt_components/RulesBaner/RulesBaner";
import CriteriaBaner from "../src/talenthunt_components/CriteriaBaner/CriteriaBaner";
import RulesAndCriteriaBaner from "../src/talenthunt_components/RulesAndCriteriaBaner/RulesAndCriteriaBaner";
...
export default function RulesandCriteria() {
  const [banner, setBanner] = useState();
  const [loder, setLoder] = useState(true);
  const [RulesandCriteriaLoader, setRulesAndCriteriaLoader] = useState(false);
  // USER Activity
    ...
    try {
      await axios
        ...
        .then((response) => {
          ...
          setLoder(false);
          setRulesAndCriteriaLoader(true);
        })
        .catch((error) => {
          // alert(error);
  ...
  return (
    ...
    >
      ...
      <RulesAndCriteriaBaner page="talenthunt" />
      <Footer />
    </div>
  );
}
